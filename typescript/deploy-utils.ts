...
import { submitSignedTx } from "./kadena-utils";
...
//   keysetName: string
// ) => {
//   const fungibleV2Iface = (
//     await fs.promises.readFile("../pact/interfaces/fungible-v2.pact")
//   ).toString();
//   const fungibleV2Result = await submitSignedTx(
//     client,
//     keys,
//     keysetName,
//     fungibleV2Iface
...
//   const fungibleXchainIface = (
//     await fs.promises.readFile("../pact/coin/fungible-xchain-v1.pact")
//   ).toString();
//   const fungibleXchainResult = await submitSignedTx(
//     client,
//     keys,
//     keysetName,
//     fungibleXchainIface
...
//   const coin = (
//     await fs.promises.readFile("../pact/coin/coin-v5.pact")
//   ).toString();
