import { sender00Account, xChainGasStation } from '../../constants/accounts.constants'
...
import { s_account } from '../../../../utils/constants'
...
`;
  ...
  const transaction = Pact.builder
    ...
    .setMeta({
      chainId,
      senderAccount: s_account.name,
      gasLimit: 2000,
      gasPrice: 0.00000001,
      ttl: 7200,
    })
    .setNetworkId(networkId)
    .addSigner(s_account.keys.publicKey, (withCapability) => [
  ...
  const signWithKeypair = createSignWithKeypair(s_account.keys);
